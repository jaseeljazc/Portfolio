...
const Header = () => {
  ...
  // State to track if the conatct form is open
  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
      <div className="flex container mx-auto px-4 sm:px-6 lg:px-8 items-center justify-between h-16 md:h-20">
        ...
        >
          <div
            className="flex h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100
        items-center justify-center text-purple-600 font-bold text-xl mr-3"
          >
            M
          </div>
          <span
        ...
        <div className=" md:flex sm:block hidden items-center space-x-4">
          <motion.a
            ...
            className=" text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 
             transform-content duration-300 "
            href="#"
          >
          ...
          <motion.button
            ...
            className=" ml-4 px-4 py-2 rounded-xl bg-gradient-to-r 
             ...
             hover:via-violet-700 hover:to-purple-700 hover:text-white
      ...
      >
        ...
        <div
          className=" pt-4 border-t border-r-gray-200 dark:border-gray-700
        "
        >
          ...
          <button
            ...
            className=" mt-4 block w-full px-2 py-2 rounded-lg 
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    rounded-lg focus:ring-2 focus:via-violet-600
